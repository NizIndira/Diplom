...
from medical.forms import PatientForm
...
class RegisterView(CreateView):
    ...
    def form_valid(self, form):
        ...
        send_mail(
            subject='Медицинский центр',
            message=f'Для активации учётной записи - '
                    f' перейдите по ссылке: http://127.0.0.1:8000{ activation_url }',

...
def parser_register_update_form(form_as_p):
    ...
    for line in form_list:
        ...
        # Лечит баг
        if 'Изменить:' in line:
            line_modified = '<div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label' \
                            'form-input-icon">' \
                            '<div class="text-left"><label for="avatar-clear_id">Изменить аватар</label></div>'
            form_list_modified.append(line_modified)

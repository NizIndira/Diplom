...
from medical.forms import AppointmentForm, FeedbackForm
from medical.models import Doctor, Appointment, Time, Patient, Feedback
...
class AppointmentCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('medical:appointments_user')
...
class AppointmentListView(LoginRequiredMixin, ListView):
    """ Список всех записей """
    model = Appointment
    template_name = 'medical/appointment_list_all.html'
...
class AppointmentDoctorListView(LoginRequiredMixin, ListView):
    ...
    model = Appointment
    template_name = 'medical/appointment_list_doctor.html'
...
class UserProfileView(LoginRequiredMixin, DetailView):
    ...
    model = User
    template_name = 'medical/user_profile.html'
...
class AppointmentDeleteView(LoginRequiredMixin, DeleteView):
    """ Удаление записи """
    model = Appointment
    success_url = reverse_lazy('medical:appointments_user')
...
class FeedbackCreateView(LoginRequiredMixin, CreateView):
    ...
    def get_success_url(self):
        ...
        return reverse_lazy('medical:user_list_feedback')
...
class FeedbackUserListView(LoginRequiredMixin, ListView):
    ...
    model = Feedback
    template_name = 'medical/feedback_user_list.html'
...
class FeedbackDeleteView(LoginRequiredMixin, DeleteView):
    """ Удаление записи """
    model = Feedback
    success_url = reverse_lazy('medical:user_list_feedback')


class FeedbackListView(LoginRequiredMixin, ListView):
    """ Просмотр отзывов всех пользователей """
    model = Feedback
    template_name = 'medical/feedback_list.html'
